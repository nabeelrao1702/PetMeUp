...
const ChatPage = () => {
  ...
  const getObject = (obj, id) => {
    if (obj?.admin1 && obj?.admin1?._id === id) {
      ...
      else if (obj?.user1) return obj?.user1;
      else if (obj?.user2) return obj?.user2;
      else if (obj?.doctor1) return obj?.doctor1;
      else if (obj?.doctor2) return obj?.doctor2;
    ...
    } else if (obj?.user1 && obj?.user1?._id === id) {
      if (obj?.admin1) return obj?.admin1;
      else if (obj?.admin2) return obj?.admin2;
      else if (obj?.user2) return obj?.user2;
      else if (obj?.doctor1) return obj?.doctor1;
      else if (obj?.doctor2) return obj?.doctor2;
    } else if (obj?.user2 && obj?.user2?._id === id) {
      if (obj?.admin1) return obj?.admin1;
      else if (obj?.admin2) return obj?.admin2;
      else if (obj?.user1) return obj?.user1;
      else if (obj?.doctor1) return obj?.doctor1;
      else if (obj?.doctor2) return obj?.doctor2;
    } else if (obj?.doctor1 && obj?.doctor1?._id === id) {
      if (obj?.admin1) return obj?.admin1;
      else if (obj?.admin2) return obj?.admin2;
      else if (obj?.user1) return obj?.user1;
      else if (obj?.user2) return obj?.user2;
      else if (obj?.doctor2) return obj?.doctor2;
    } else if (obj?.doctor2 && obj?.doctor2?._id === id) {
      if (obj?.admin1) return obj?.admin1;
      else if (obj?.admin2) return obj?.admin2;
      else if (obj?.user1) return obj?.user1;
      else if (obj?.user2) return obj?.user2;
  ...
  function getMessages(obj, id) {
    if (obj?.sender_admin && obj?.sender_admin?._id === id) {
      ...
      else if (obj?.sender_user) return obj?.sender_user;
      else if (obj?.receiver_user) return obj?.receiver_user;
      else if (obj?.sender_doctor) return obj?.sender_doctor;
      else if (obj?.receiver_doctor) return obj?.receiver_doctor;
    ...
    } else if (obj?.sender_user && obj?.sender_user?._id === id) {
      if (obj?.sender_admin) return obj?.sender_admin;
    ...
    } else if (obj?.sender_doctor && obj?.sender_doctor?._id === id) {
      if (obj?.sender_admin) return obj?.sender_admin;
      else if (obj?.receiver_admin) return obj?.receiver_admin;
      else if (obj?.sender_user) return obj?.sender_user;
      else if (obj?.receiver_user) return obj?.receiver_user;
      else if (obj?.receiver_doctor) return obj?.receiver_doctor;
    } else if (obj?.receiver_doctor && obj?.receiver_doctor?._id === id) {
      if (obj?.sender_admin) return obj?.sender_admin;
      else if (obj?.receiver_admin) return obj?.receiver_admin;
      else if (obj?.sender_user) return obj?.sender_user;
      else if (obj?.receiver_user) return obj?.receiver_user;
    ...
    axios
      .post(
        `http://localhost:5000/conversations/${selectedConversation._id}/messages`,
        {
          ...
          sender_doctor: id,
          sender_admin: id,
          receiver_user: getObject(selectedConversation, id)?._id,
          receiver_doctor: getObject(selectedConversation, id)?._id,
          ...
          <div className="col-span-3 sm:col-span-2 -mt-48 sm:-mt-0  bg-white">
            <div className="w-full">
                      ...
                      <li key={index} className="clearfix2">
                        <div
                          className={
                            ...
                            id === message?.sender_user?._id ||
                            id === message?.sender_doctor?._id
                        ...
                        >
                          <div
                            className={
                              ...
                              id === message?.sender_user?._id ||
                              id === message?.sender_doctor?._id
                                ? "bg-orange-100 rounded px-5 py-2 my-2 text-orange-800 relative "
              ...
              <div className="w-full py-3 px-3 flex items-center justify-between border-t border-gray-300">
                <input
                  className=" py-2 mx-3 pl-5 block w-full bg-white border rounded-md shadow-md border-slate-300 placeholder-slate-400 focus:outline-none focus:border-orange-500 focus:ring-orange-500 block w-full text-sm focus:ring-1 "
                  type="text"
                  value={newMessage}
