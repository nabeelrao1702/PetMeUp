...
const OngoingGig = () => {
  ...
  const [days, setDays] = useState(
    sessionStorage.getItem(`gigDaysUser-${singleOrderId}`) || duration
  );
  const [hours, setHours] = useState(
    sessionStorage.getItem(`gigHoursUser-${singleOrderId}`) || 0
  );
  const [minutes, setMinutes] = useState(
    sessionStorage.getItem(`gigMinutesUser-${singleOrderId}`) || 0
  );
  const [seconds, setSeconds] = useState(
    sessionStorage.getItem(`gigSecondsUser-${singleOrderId}`) || 0
  );

  useEffect(() => {
    sessionStorage.setItem(`gigDaysUser-${singleOrderId}`, days);
    sessionStorage.setItem(`gigHoursUser-${singleOrderId}`, hours);
    sessionStorage.setItem(`gigMinutesUser-${singleOrderId}`, minutes);
    sessionStorage.setItem(`gigSecondsUser-${singleOrderId}`, seconds);
    ...
    <div>
        <>
          <div className="flex flex-wrap w-auto mx-6 lg:mx-20 my-8">
            ...
            <div className="w-full lg:w-1/2 h-auto flex-grow border border-3 lg:rounded-l-md border-r-1 border-gray-300 py-2">
  <div className="w-full h-auto flex-grow px-6 space-y-2 ">
  ...
  <div className="w-full h-auto flex-grow px-6">
    <p className="font-medium text-gray-700 my-2">
              ...
              <div className="w-full h-auto flex-grow px-6 mt-2 mb-3 space-y-2">
    <div className="w-full h-auto flex-grow font-semibold mb-3">
                  <h3>Pet Details</h3>
                </div>
              ...
              <div className="flex flex-col flex-wrap w-auto flex-grow px-4 my-4 space-y-3">
                <div className="item">
                  <div className="flex px-2 py-2 text-sm font-thin text-gray-700 bg-yellow-300 rounded-md ">
                    ...
                    <span className="-mt-1">
                      Check-Up Within: {gigOrder?.duration} Days
                    </span>
                  </div>
                </div>
                {/* <div className="item">
                  <div className="flex px-2 py-2 text-sm font-thin text-gray-600 bg-yellow-300  rounded-md ">
                    ...
                    <span className="-mt-1">
                      User Est.Budget: {getPackage(gigOrder?.duration, gigOrder?.price)}
                    </span>
                  </div>
                </div> */}
                <div className="item">
