...
import { AdPetProfiles } from "../../../redux/actions/UserActions";
...
const AddPetProfileForm = () => {
  ...
  const onSubmit = (formValues) => {
    dispatch(AdPetProfiles(formValues, navigate, toast));
  };
                                ...
                                >
                                  <div className="flex  flex-row space-x-4 ">
                                    <div className="item  basis-1/2">
                                      ...
                                      <Field
                                        name={`tags.${index}`}
                                        placeholder="Pedigree || Achievements"
                                        type="text"
