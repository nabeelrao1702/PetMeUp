...
import { SubmitPetProfileRequest } from "../../../redux/actions/UserActions";
...
const SendRequestForm = () => {
  const { singlePetProfile } = useLocation().state;
  ...
  const formData = {
    petProfilesId: singlePetProfile._id,
    recentExperience: "",
    duration: "",
    coverLetter: "",
    bid: "",
  ...
  const onSubmit = (formValues) => {
    dispatch(SubmitPetProfileRequest(formValues, navigate, toast));
  };

  const validate = Yup.object({
    recentExperience: Yup.string()
      .min(50, "It must have at least 50 words")
      .required("Fill in the fields"),
    coverLetter: Yup.string()
      .min(50, "It must have at least 200 words")
      .required("Fill in the fields"),
    duration: Yup.number().required("Matting Duration is Required").positive().min(1),
      ...
      <div className="flex flex-wrap w-auto mx-6 lg:mx-20 my-8">
        ...
        <div className="item w-full lg:w-1/2  h-auto flex-grow border border-3 lg:rounded-l-md border-r-1  border-gray-300 py-2">
          <div className="item w-full h-auto flex-grow px-6 space-y-2 ">
            ...
            <div className="item w-full h-auto flex-grow ">
              <h2 className="text-xl font-medium tracking-tight text-gray-900 mb-4">
                {singlePetProfile?.title}
              </h2>
            </div>

            <div className="item w-full h-auto flex-grow text-sm text-gray-500 ">
              <p>Posted On {dateConverter(singlePetProfile?.createdAt)}</p>
            </div>
            <div className="item w-full h-auto flex-grow">
              <div className="flex items-center text-sm font-semibold text-sky-500 space-x-1">
                ...
                <span className=" text-sm text-gray-500">
                  {singlePetProfile?.user?.address?.country}
                </span>
              </div>
            </div>
          ...
          <div className="item w-full h-auto flex-grow px-6 mt-2 mb-3 space-y-2">
            ...
            <div className="item w-full h-auto flex-grow  ">
              <div className="flex flex-row flex-wrap space-x-2 w-full ">
                {singlePetProfile?.tags?.map((tag, index) => (
                  <div
                    key={index}
          ...
          <div className="item w-full h-auto flex-grow px-6 mt-2 mb-3 space-y-2">
            ...
            <div className="item w-full h-auto flex-grow  ">
              <div className="flex flex-row flex-wrap space-x-2 w-full ">
                {singlePetProfile?.petvs?.map((petv, index) => (
                  <div
                    key={index}
            ...
            <div className="item w-full h-auto flex-grow  ">
              <div className="flex flex-row flex-wrap space-x-2 w-full ">
                <div className=" px-3 py-1 text-sm font-thin text-white bg-cyan-600  rounded-md ">
                  <span>
                    Looking for: {singlePetProfile?.requiredSkills}
                  </span>
                </div>
                <div className="px-3 py-1 text-sm font-thin text-white bg-cyan-600  rounded-md">
                  <span>
                    Pet Category: {singlePetProfile?.offeredSkills}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col flex-wrap w-auto flex-grow px-4 my-4 space-y-3">
            <div className="item">
              <div className="flex px-2 py-2 text-sm font-thin text-gray-700 bg-gray-300 rounded-md ">
                ...
                <span className="-mt-1">
                  Pet Matting Duration: {singlePetProfile?.duration} days
                </span>
              </div>
            </div>
            ...
            <div className="item">
              <div className="flex px-2 py-2  text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                  {" "}
                  User Est. Budget: ${singlePetProfile?.price?.beginnerLevel}
                </span>
              </div>
            </div>
            {/* <div className="item">
                  ...
                  <div className="flex flex-wrap justify-between w-auto">
                    ...
                    <div className="item">
                      <h2 className="text-xl font-medium tracking-tight text-gray-700 mb-4 ">
                        User's Est. Budget: $ {singlePetProfile?.price?.beginnerLevel}
                      </h2>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="item">
                      <div className="flex flex-col flex-wrap w-auto space-y-4">
                        <div className="item font-medium tracking-tight text-gray-700 ">
                          <p>How much will you like to offer?</p>
                        </div>
                        <div className="item">
              ...
              <div className="item w-full lg:w-1/2  h-auto flex-grow border border-3 lg:rounded-md border-gray-300 py-2">
                ...
                <div className="item w-full h-auto flex-grow px-6 my-4 ">
                  <div className="col-span-6 sm:col-span-3 mb-6">
                    ...
                    >
                      In how many days are you available for Pet Matting? 
                    </label>
                ...
                <div className="col-span-6 sm:col-span-6 px-6">
                  ...
                  <div className="mt-1">
                    <Field
                      ...
                      placeholder="Give details about your Pet"
                    />
                  </div>
                ...
                <div className="col-span-6 sm:col-span-6 px-6">
                  ...
                  <div className="mt-1">
                    <Field
                      ...
                      className="shadow-sm focus:ring-orange-500 focus:border-orange-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"
                      placeholder="Give the terms and condition Criteria"
                    />
                  </div>
                  <p className="mt-2 text-sm text-gray-500">
                    Min. 50 characters
                            ...
                            >
                              <div className="flex flex-row space-x-4 ">
                                <div className="item  basis-full">
                                  ...
                                  >
                                    Include a link to your SocialMedia for authenticity
                                  </label>
                                  <Field
                ...
                <div className="item w-full h-auto flex-grow px-6 ">
                  <div className="flex flex-wrap items-center w-auto space-x-8">
                    <div className="item">
                      <button
                        type="submit"
                        className="w-48 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
                      >
                        Send Request
                      </button>
                    </div>
