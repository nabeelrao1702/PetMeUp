...
const SinglePetProfile = ({ data, reviews }) => {
  const {
    requiredSkills,
    offeredSkills,
    petcity,
        ...
        <div className=" mt-2 bg-white rounded-lg shadow-md  border border-3 -mb-12 ">
          <div className="flex flex-col flex-wrap space-y-2  p-3">
            ...
            <div className="flex flex-row flex-wrap space-x-2">
              <div>
                <div className="flex items-center justify-around px-2 py-1 text-sm font-thin text-gray-700 bg-yellow-300  rounded-md ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Pet Matting: {duration} days</span>
                </div>
              </div>

              <div>
                <div className="flex items-center justify-around px-2 py-1 -ml-2 sm:ml-0 mt-2 sm:mt-0 text-sm font-thin text-gray-600 bg-yellow-300  rounded-md ">
                  <svg
                  ...
                  <span>User Budget: ${price.beginnerLevel}</span>
                </div>
              </div>
...
export default SinglePetProfile;
