...
const MyBlogs = () => {
  ...
  const myBlogs = useSelector((state) => state.userData.myBlogs.snapshot);
  ...
  function hasBlogs(myBlogs, indexOfFirstUser, indexOfLastUser) {
    ...
    <div className="h-full pb-16 overflow-y-auto">
        ...
        <div className="container  mx-auto grid">
          <div className="flex flex-row flex-wrap  items-center justify-between my-4">
            <Title title="Your Stories" />
            <Link to="/user/blogs/add">
          ...
          {myBlogs && myBlogs.length > 0 ? (
            ...
            <div className="flex justify-center w-full">
              <EmptyState message="You don't have any Story" />
            </div>
          )}
        </div>
    </div>
