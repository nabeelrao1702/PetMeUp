...
const Proposals = () => {
  ...
  const proposals = useSelector(
    (state) => state?.userData?.proposals?.response
  );


  useEffect(() => {
    dispatch(GetAllJobsProposalsForUser(toast));
  }, [dispatch]);
    ...
    <div className="h-full pb-16 overflow-y-auto">
        <div className="container  mx-auto grid">
          <div className="flex flex-row flex-wrap  items-center justify-between mb-4">
            <Title title="Pending Submitted Doctor Proposals" />
          </div>
          {pendingProposals && pendingProposals.length > 0 ? (
                ...
                <table className="w-full whitespace-no-wrap">
                  <thead>
                    <tr className="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border boder-gray-500   bg-gray-100">
                      ...
                      <th className="px-4 py-3">Follow-Up Visit</th>
            ...
            <div className="flex justify-center w-full">
              <EmptyState message="You don't have any Pending Doctor Proposals" />
            </div>
          )}
          <div className="flex flex-row flex-wrap  items-center justify-between mb-4">
            <Title title="Accepted Doctor Proposals" />
          </div>
          {acceptedProposals && acceptedProposals.length > 0 ? (
            ...
            <div className="flex justify-center w-full">
              <EmptyState message="You don't have any Accepted Doctor Proposals" />
            </div>
          )}
          <div className="flex flex-row flex-wrap  items-center justify-between mb-4">
            <Title title="Rejected Doctor Proposals" />
          </div>
          {rejectedProposals && rejectedProposals.length > 0 ? (
            ...
            <div className="flex justify-center w-full">
              <EmptyState message="You don't have any Rejected Doctor Proposals" />
            </div>
          )}
        </div>
    </div>
