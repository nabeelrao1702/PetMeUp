...
const PaymentMethods = () => {
  ...
  const { loading, payments } = useSelector((state) => state?.userData);
  const freeuserId = useSelector((state) => state?.userData?.freeuserInfo?._id);

  useEffect(() => {
    dispatch(getUserPayment(freeuserId, toast));
  }, [dispatch, freeuserId]);
  ...
  const onSubmit = async (formValues) => {
    dispatch(addUserPayment(formValues, navigate, toast));
  };
  ...
  const delPayment = (paymentId) => {
    dispatch(deleteUserPayment(paymentId, toast));
    setDeleteModal(false);
  };
                        ...
                        <Form>
                          <div className=" mx-auto overflow-hidden rounded-lg">
                                ...
                                <>
                                  ...
                                  <div className="col-span-3  ">
                                    ...
                                    <Field
                                      type="email"
                                      name="email"
                                      placeholder="nabeelrao1702@gmail.com"
                                      className="mt-1 focus:ring-orange-500 focus:border-orange-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    />
                                    <div className="mt-2 text-sm text-red-600 dark:text-red-500">
                                      <ErrorMessage
                            ...
                            <div className="px-4 py-3 text-right sm:px-6 ">
                              <button
                                type="submit"
                                className="w-56 inline-flex justify-center py-2 px-4  border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
                              >
                                Add Payment Method
                              </button>
                            </div>
                      ...
                      <div className=" bg-white text-gray-700 py-3 rounded">
                        ...
                        <p className=" text-sm mt-4">
                          ...
                          <button
                            ...
                            className="hover:underline hover:text-orange-600 cursor-pointer font-bold "
                          >
