...
import { SendProposal } from "../../../redux/actions/UserActions";
                      ...
                      <div className="flex flex-wrap justify-between w-auto">
                        ...
                        <div className="item">
                          <h2 className="text-xl font-medium tracking-tight text-gray-700 mb-4 ">
                            Doctor's Check-Up Fee: ${singleJob.budget}
                          </h2>
                        </div>
                      </div>
                    </div>
                                ...
                                >
                                  <div className="flex flex-row space-x-4 ">
                                    <div className="item  basis-full">
                                      ...
                                      >
                                        Include your social media link, for Authentication.
