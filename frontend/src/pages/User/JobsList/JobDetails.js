    ...
    <div>
      <div className="flex flex-wrap w-auto mx-6 lg:mx-20 my-8 ">
        ...
        <div className="item w-full lg:w-1/2  h-auto flex-grow border border-3 lg:rounded-l-md border-r-1  border-gray-300 py-2">
          ...
          <div className="item w-full h-auto flex-grow px-6 my-4">
            <div className="flex flex-row flex-wrap space-x-2">
              <div>
                <div className="flex items-center justify-around px-2 py-2 text-sm font-thin text-gray-700 bg-yellow-300  rounded-md ">
                  <svg
                  ...
                  <span className="-mt-1">Visit In: {duration}</span>
                </div>
              </div>
              <div>
                <div className="flex items-center justify-around px-2 py-2 -ml-2 sm:ml-0 mt-2 sm:mt-0 text-sm font-thin text-gray-600 bg-yellow-300  rounded-md ">
                  <svg
              ...
              <div>
                <div className="flex items-center justify-around px-2 py-2 ml-2 sm:ml-0 mt-2 sm:mt-0 text-sm font-thin text-gray-600 bg-yellow-300  rounded-md ">
                  ...
                  <span className="-mt-1">Check-Up Fee: ${budget}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="item w-full lg:w-1/4 h-auto border-3 border lg:rounded-r-md border-l-1 lg:border-l-0 border-gray-300 ">
          <div className="item w-full h-auto flex-grow px-6 my-4 ">
            <Link to="/user/send-proposal-form" state={{ singleJob }}>
          ...
          <div className="item w-full h-auto flex-grow px-6 my-4 space-y-2 ">
            ...
            <div className="item w-full h-auto flex-grow font-semibold text-gray-700 ">
              <h3>{doctor?.address?.country}</h3>
            </div>

            <div className="item w-full h-auto flex-grow font-semibold text-gray-700 ">
              <h3>Member Since {dateConverter(doctor?.createdAt)}</h3>
            </div>
          </div>
        </div>
      </div>
