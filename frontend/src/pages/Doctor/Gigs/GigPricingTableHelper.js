import { CreateGigOrder } from "../../../redux/actions/DoctorActions";
        ...
        <>
          <div className="flex flex-col flex-nowrap">
            ...
            <div className="item mx-6 my-4">
              <div>
                <div className="flex items-center text-sm font-thin text-gray-700 rounded-md ">
                  ...
                  <span className="-mt-1 text-sm font-medium text-gray-500 ">
                    {props.Revisions} Follow-up Visit
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="item mx-6 my-4 ">
              <div>
                <button
                  className="w-full h-12 px-12 text-sm font-medium text-white transition-colors duration-150 bg-orange-600 border border-transparent rounded-md active:bg-orange-600 hover:bg-orange-700 focus:outline-none focus:shadow-outline-orange"
