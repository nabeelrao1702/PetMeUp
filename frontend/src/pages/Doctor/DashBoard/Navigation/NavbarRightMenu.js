...
import { GetDoctorInformation } from "../../../../redux/actions/DoctorActions";
...
const RightMenu = () => {
  ...
  const { photo } = freeuserInfo;

  useEffect(() => {
    dispatch(GetDoctorInformation(freeuserId, toast));
  }, [dispatch, freeuserId]);
      ...
      <div className="flex items-center">
        <div ref={notificationMenuRef}>
          <li className="relative flex ml-4 text-gray-500 ">
            <button
              className="align-middle rounded-full focus:shadow-outline-orange focus:outline-none"
