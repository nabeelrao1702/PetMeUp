...
const DoctorPageUserDetails = () => {
  const { singleUser } = useLocation()?.state;
  ...
  return (
    <div>
      <div className="flex flex-wrap w-auto mx-6 lg:mx-20 my-8 ">
        ...
        <div class="item w-full lg:w-1/2  h-auto flex-grow border border-3 lg:rounded-r-md border-l-1  border-gray-300 py-2">
        {/* <div class="flex flex-col flex-nowrap justify-center items-center space-y-2 my-4"> */}
          <div className="item px-6 my-4 ">
            ...
            <div className="item px-61 my-4  " style={{ flex: 1 }} >
            <h2 className=" text-xl font-medium text-gray-900 my-4  ">
              Expertise
            </h2>
...
export default DoctorPageUserDetails;
