...
import { UpdateDoctorAccount } from "../../../../redux/actions/DoctorActions";
                ...
                <div className="item">
                  <div className="flex flex-nowrap justify-between items-center">
                    ...
                    <div className="item w-1/2">
                      <Field
                        type="password"
                        className=" bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-orange-500 focus:ring-orange-500 block w-full rounded-md sm:text-sm focus:ring-1"
                        placeholder="••••••••"
                        label="password"
                        name="password"
                      />
