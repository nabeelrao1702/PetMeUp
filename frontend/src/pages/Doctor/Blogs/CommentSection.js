...
const CommentSection = ({ blogDetail, reviews }) => {
  ...
  const filteredReviews = reviews?.filter(
    (review) => review?.user?._id === blogDetail?.user[0]?._id
  );
        ...
        <div className="flex flex-wrap w-auto mx-6 lg:mx-22 my-8 mb-12">
                  ...
                  <div className="item w-full h-auto flex-grow px-6 space-y-2 ">
                    ...
                    <div className="item w-full h-auto flex-grow font-semibold text-gray-700 ">
                      <Field
                        ...
                        cols="33"
                        name="comment"
                        className="w-full px-4 py-3 mb-4 border border-3 border-orange-400 rounded-lg focus:ring focus:ring-orange-500 focus:outline-none"
                    ...
                    <div className="item w-full h-auto flex-grow font-semibold text-gray-700 ">
                      <input
                        ...
                        name="submit"
                        className="text-white px-3 py-2 bg-orange-600 cursor-pointer hover:bg-orange-700 rounded-md"
                      />
                    </div>
                  </div>
                </Form>
            ...
            <div className="item w-full h-auto flex-grow px-6 ">
              ...
              {blogDetail?.comment && blogDetail?.comment.length > 0 ? (
                        ...
                        blogDetail?.comment?.map((comment, index) => (
                          <div key={index} className="flex flex-row">
                            <img
                              ...
                              src={comment?.doctor_id[0]?.photo}
                            />
                            <div className="flex-col mt-1">
                              <div className="flex items-center flex-1 px-4 font-bold leading-tight">
                                {comment?.doctor_id[0]?.firstName}{" "}
                                {comment?.doctor_id[0]?.lastName}
                                        ...
                                        <div className="item w-full h-auto flex-grow px-6 space-y-1 ">
                                          ...
                                          <div className="item w-full h-auto  flex-grow font-semibold text-gray-700 ">
                                            <input
                                              ...
                                              value="Submit reply"
                                              name="submit"
                                              className="text-white px-3 py-2 -mt-4 mb-2 bg-orange-600 cursor-pointer hover:bg-orange-700 rounded-md"
                                            />
                                          </div>
                                        </div>
                                      </Form>
                                  ...
                                  handleCompare(
                                    ...
                                    >
                                      <img
                                        ...
                                        alt="Noob master's avatar"
                                        src={
                                          RComment?.doctor_id[0]?.photo
                                            ? RComment?.doctor_id[0]?.photo
                                            : RComment?.user_id[0]?.photo
                                        }
                                      />
                                      <div className="flex-col mt-1">
                                        <div className="flex items-center flex-1 px-4 font-bold leading-tight">
                                          {RComment?.doctor_id[0]?.firstName
                                            ? RComment?.doctor_id[0]?.firstName
                                            : RComment?.user_id[0]
                                                ?.firstName}{" "}
                                          {RComment?.doctor_id[0]?.lastName
                                            ? RComment?.doctor_id[0]?.lastName
                                            : RComment?.user_id[0]
                                                ?.lastName}
                                          <span className="ml-2 text-xs font-normal text-gray-500">
                ...
                <div className="flex justify-center w-full">
                  <EmptyState message="No Comments on this Story Post" />
                </div>
              )}
            </div>
          </div>
          <div className="item w-full lg:w-1/4 h-auto border-3 border lg:border-r-0 lg:border-b-0 lg:border-t-0 border-gray-300 ">
            <div className="item w-full h-auto flex-grow px-6 my-4 space-y-3 ">
              ...
              <div className="item w-full h-auto flex-grow font-semibold text-gray-700 ">
                <h3>{blogDetail?.user[0]?.address?.country}</h3>
              </div>

              <div className="item w-full h-auto flex-grow font-semibold text-gray-700 ">
                <h3>
                  Member since{" "}
                  {dateConverter(blogDetail?.user[0]?.createdAt)}
                </h3>
              </div>
            </div>
          </div>
