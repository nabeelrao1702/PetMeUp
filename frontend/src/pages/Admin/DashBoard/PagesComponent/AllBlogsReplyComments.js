            ...
            {blogsReplyComments && blogsReplyComments.length > 0 ? (
              <div className="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        hasBlogsReplyComments(
                          ...
                          <tr key={index} className="text-gray-700 ">
                            ...
                            <td className="px-4 py-3 text-sm">
                              {blogsReplyComment?.doctor_id[0]?.firstName
                                ? blogsReplyComment?.doctor_id[0]?.firstName
                                : blogsReplyComment?.user_id[0]
                                    ?.firstName}{" "}
                              {blogsReplyComment?.doctor_id[0]?.lastName
                                ? blogsReplyComment?.doctor_id[0]?.lastName
                                : blogsReplyComment?.user_id[0]?.lastName}
                            </td>
                              ...
                              <div className="flex items-center space-x-4 text-sm">
                                ...
                                {deleteModal && (
                                  <Modal
                                    ...
                                    comment={"Story Comment Reply"}
                                    message={"Story Comment Reply"}
                                  />
                                )}
                              </div>
                            </td>
                ...
                <Pagination
                  ...
                  totalUsers={blogsReplyComments?.length}
                  paginate={paginate}
              ...
              <div className="flex justify-center w-full">
                <EmptyState message="No Story Reply Comments To Show" />
              </div>
            )}
          </div>
        </div>
