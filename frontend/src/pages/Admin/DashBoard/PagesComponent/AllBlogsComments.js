        ...
        <div className="h-full pb-16 overflow-y-auto">
          <div className="container  mx-auto grid">
            <div className="flex flex-row flex-wrap  items-center justify-between mb-4">
              {/* <Title title=" Story Comments List" /> */}
            ...
            {blogsComments && blogsComments.length > 0 ? (
              <div className="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        hasBlogComments(
                          ...
                          <tr key={index} className="text-gray-700 ">
                            ...
                            <td className="px-4 py-3 text-sm">
                              {blogsComment?.doctor_id[0]?.firstName}{" "}
                              {blogsComment?.doctor_id[0]?.lastName}
                            </td>
                ...
                <Pagination
                  ...
                  totalUsers={blogsComments?.length}
                  paginate={paginate}
              ...
              <div className="flex justify-center w-full">
                <EmptyState message="No Story Comment To Show" />
              </div>
            )}
          </div>
        </div>
