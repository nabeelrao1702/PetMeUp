...
import { DeletePetProfiles } from "../../../redux/actions/AdminActions";
import { useDispatch } from "react-redux";
import Modal from "../DashBoard/PagesComponent/Helpers/Modal";

const ViewPetProfile = () => {
  const petProfilesDetails = useLocation()?.state?.petProfile;
            ...
            <div className="flex flex-row flex-wrap space-x-2">
              ...
              {/* <div>
                <div className="flex items-center justify-around px-2 py-2 ml-2 sm:ml-0 mt-2 sm:mt-0 text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                  ...
                  <span className="-mt-1">
                    User Est.budget: ${price.intermediate}
                  </span>
                </div>
              </div> */}
              {/* <div>
                <div className="flex items-center justify-around px-2 py-2 ml-2 sm:ml-0 mt-2 sm:mt-0 text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                  ...
                  <span className="-mt-1">User Est.Budget: ${price.expert}</span>
                </div>
              </div> */}
            </div>
          </div>
        ...
        <div className="item w-full lg:w-1/4 h-auto border-3 border lg:rounded-r-md border-l-1 lg:border-l-0 border-gray-300 ">
          <div className="item w-full h-auto flex-grow px-6 my-4 ">
            <button
              ...
              className="w-full h-12 px-12 text-sm font-medium text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-md active:bg-orange-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-orange"
            >
              <span>Delete</span>
            </button>
            {deleteModal && (
