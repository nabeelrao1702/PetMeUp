            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {jobOrder.doctor.firstName} {jobOrder.doctor.lastName}
                  </span>
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col flex-wrap w-auto flex-grow px-4 my-4 space-y-3">
            <div className="item">
              <div className="flex px-2 py-2 text-sm font-thin text-gray-700 bg-gray-300 rounded-md ">
                ...
                <span className="-mt-1">
                  Session In: {jobOrder?.jobOrderType.duration} Days
                </span>
              </div>
            </div>
            <div className="item">
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {jobOrder?.userPayments[0]?.CardDetails?.cardId}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {jobOrder?.userPayments[0]?.CardDetails?.customerId}{" "}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {" "}
                    {jobOrder?.userPayments[0]?.CardDetails?.email}{" "}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {jobOrder?.userPayments[0]?.CardDetails?.name}{" "}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  <span className=" font-medium text-gray-900 ">Card Id: </span>
                  <span className="font-regular text-gray-600">
                    {jobOrder?.doctorPayments[0]?.CardDetails?.cardId}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {jobOrder?.doctorPayments[0]?.CardDetails?.customerId}{" "}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {" "}
                    {jobOrder?.doctorPayments[0]?.CardDetails?.email}{" "}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-nowrap justify-center space-y-1  ">
              <div className="item ">
                <p>
                  ...
                  <span className="font-regular text-gray-600">
                    {jobOrder?.doctorPayments[0]?.CardDetails?.name}{" "}
                  </span>
                </p>
              </div>
            </div>
