  ...
  return (
    <div>
      <div className="item bg-gray-100 border-b ">
        <div className="grid overflow-hidden divide-x text-lg justify-evenly items-center font-semibold tracking-wide text-left text-orange-600 border-b cursor-pointer grid-cols-3 grid-rows-1  text-center w-auto h-auto">
          {/* <div
