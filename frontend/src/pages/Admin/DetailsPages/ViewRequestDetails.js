...
import { DeletePetProfilesRequest } from "../../../redux/actions/AdminActions";
import { useDispatch } from "react-redux";
import Modal from "../DashBoard/PagesComponent/Helpers/Modal";

const ViewRequestDetails = () => {
  const petProfilesRequestDetails =
    useLocation()?.state?.petProfilesRequest;
            ...
            <div className="item w-full h-auto flex-grow  ">
              <div className="flex flex-row flex-wrap space-x-2 w-full ">
                <div className=" px-3 py-1 text-sm font-thin text-white bg-cyan-600  rounded-md ">
                  <span>
                    Required Pet Breed: {petProfilesId?.requiredSkills}
                  </span>
                </div>
                <div className="px-3 py-1 text-sm font-thin text-white bg-cyan-600  rounded-md">
                  <span>Pet Category: {petProfilesId?.offeredSkills}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col flex-wrap w-auto flex-grow px-4 my-4 space-y-3">
            <div className="item">
              <div className="flex px-2 py-2 text-sm font-thin text-gray-700 bg-gray-300 rounded-md ">
                ...
                <span className="-mt-1">
                  Matting Duration: {petProfilesId?.duration} days
                </span>
              </div>
            </div>
            ...
            <div className="item">
              <div className="flex px-2 py-2  text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                  User Est. Price: ${petProfilesId?.price?.beginnerLevel}
                </span>
              </div>
            </div>
            <div className="item">
              <div className="flex px-2 py-2  text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                User Est. Price: ${petProfilesId?.price?.intermediate}
                </span>
              </div>
            </div>
            <div className="item">
              <div className="flex px-2 py-2  text-sm font-thin text-gray-600 bg-gray-300  rounded-md ">
                ...
                <span className="-mt-1">
                User Est. Price: ${petProfilesId?.price?.expert}
                </span>
              </div>
            </div>
          </div>
